            ...
            if (!relative.path) {
              ...
              if (relative.path.charAt(0) === '/') {
                ...
                if (
                  ...
                  target.path =
                    base2.path.slice(0, base2.path.lastIndexOf('/') + 1) + relative.path;
                }
    ...
    function compile(schema, root, localRefs, baseId) {
      ...
      function resolveRef(baseId2, ref, isRoot) {
        ...
        if (v2 === void 0) {
          ...
          if (localSchema) {
            v2 = resolve2.inlineRef(localSchema, opts.inlineRefs)
              ? localSchema
...
var IconSchema = external_exports
  .object({
    /**
    ...
    if (this._capabilities.logging) {
      this.setRequestHandler(SetLevelRequestSchema, async (request, extra) => {
        ...
        const transportSessionId =
          extra.sessionId ||
          ((_a2 = extra.requestInfo) === null || _a2 === void 0
            ? void 0
...
var ConfigSchema = external_exports.object({
  ...
  introspection: external_exports
    .object({
...
// src/cli/init.ts
import { mkdir, writeFile, existsSync as existsSync2, readFile } from 'fs';
